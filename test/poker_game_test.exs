...
defmodule PokerGameTest do
  ...
  # test " something" do
  #   hand_1 = PokerGame.hand(["2D", "3H", "9H", "8C", "KS"])
  #   assert PokerGame.no_pairs?(hand_1)

  #   hand_2 = PokerGame.hand(["2D", "2H", "9H", "8C", "KS"])
  #   refute PokerGame.no_pairs?(hand_2)
  # end
  #   hand_2 = PokerGame.hand(["2S", "3D", "9D", "8H", "10S"])

  # test "hand with pair wins against no pair" do
  #   black = PokerGame.hand(["2D", "2H", "3H", "4C", "KS"])
  #   white = PokerGame.hand(["2S", "4D", "9D", "8H", "10S"])
  ...
  #   black = PokerGame.hand(["2D", "2H", "2S", "8C", "KS"])
  #   white = PokerGame.hand(["3S", "3D", "9D", "8H", "10S"])

  #   black_2 = PokerGame.hand(["4D", "4H", "9H", "8C", "KS"])
  #   white_2 = PokerGame.hand(["3S", "3D", "3C", "8H", "10S"])

  #   assert "Black Wins - 3 of a kind" == PokerGame.compare(black, white)
  #   assert "White Wins - 3 of a kind" == PokerGame.compare(black_2, white_2)
  # end

  # test "hand with straight wins against 3 of a kind" do
  #   black = PokerGame.hand(["2D", "3H", "4S", "5C", "6S"])
  #   white = PokerGame.hand(["3S", "3H", "3D", "8H", "10S"])

  #   black_2 = PokerGame.hand(["4D", "4H", "9H", "8C", "KS"])
  #   white_2 = PokerGame.hand(["3S", "4D", "5C", "6H", "7S"])

  #   assert "Black Wins - Straight" == PokerGame.compare(black, white)
  #   assert "White Wins - Straight" == PokerGame.compare(black_2, white_2)
  # end
end
